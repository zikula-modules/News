...
abstract class AbstractMessageRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'MU\NewsModule\Entity\MessageEntity';
    ...
    public function updateUserField($userFieldName, $userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        if (empty($userFieldName) || !in_array($userFieldName, ['approver'])) {
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved messageEntity instances
     */
     ...
     * @param integer $excludeId  Id of messages to exclude (optional)
     *
