...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from news app';
     *     $event->getRequest()->attributes->set('MUNewsModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUNewsModule_test');`
     *     now `$testMessage` should be: `'Hello from news app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('news App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
