 ...
 */
abstract class AbstractMUNewsModule extends AbstractTaggedObjectMeta implements ContainerAwareInterface
{
    use ContainerAwareTrait;

    /**
     * MUNewsModule constructor.
     *
    ...
    function __construct($objectId, $areaId, $module, $urlString = null, UrlInterface $urlObject = null)
    {
        ...
        $objectType = isset($urlArgs['ot']) ? $urlArgs['ot'] : 'message';
