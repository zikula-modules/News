...
namespace MU\NewsModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUNewsModule:js/MUNewsModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUNewsModule:js/MUNewsModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUNewsModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['message'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('MUNewsModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUNewsModule_objecttype', 'message');
