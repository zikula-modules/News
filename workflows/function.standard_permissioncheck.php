 ...
 */
function MUNews_workflow_standard_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    // every user is allowed to perform automatic archiving 
    if (PageUtil::getVar('MUNewsAutomaticArchiving', false) === true) {
        return true;
    }
 ...
 */
function MUNews_workflow_standard_gettextstrings()
{
    return array(
        ...
        'states' => array(
            ...
            no__('Archived') => no__('Content has reached the end and became archived.'),
        ...
        'actions' => array(
            ...
            'approved' => array(
                ...
                no__('Archive') => no__('Move content into the archive.'),
                no__('Delete') => no__('Delete content permanently.')
            )
            ,
            'suspended' => array(
