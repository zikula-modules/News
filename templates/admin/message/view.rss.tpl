{* purpose of this template: messages rss feed in admin area *}
...
{foreach item='message' from=$items}
    <item>
        ...
        <link>{modurl modname='MUNews' type='admin' func='display' ot='message' id=$message.id slug=$message.slug fqurl='1'}</link>
        <guid>{modurl modname='MUNews' type='admin' func='display' ot='message' id=$message.id slug=$message.slug fqurl='1'}</guid>
