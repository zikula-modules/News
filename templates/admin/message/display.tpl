{* purpose of this template: messages display view in admin area *}
...
<div class="munews-message munews-display">
    ...
    <div class="z-admin-content-pagetitle">
        ...
        <h3>{$templateTitle|notifyfilters:'munews.filter_hooks.messages.filter'} <small>({$message.workflowState|munewsObjectState:false|lower})</small>{icon id='itemActionsTrigger' type='options' size='extrasmall' __alt='Actions' class='z-pointer z-hide'}</h3>
    </div>
    ...
    {include file='admin/include_categories_display.tpl' obj=$message}
    {include file='admin/include_standardfields_display.tpl' obj=$message}
