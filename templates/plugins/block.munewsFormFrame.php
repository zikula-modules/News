...
/**
 * The munewsFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_munewsFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MUNews_Form_Plugin_FormFrame', $params, $content);
