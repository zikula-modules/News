...
/**
 * The munewsShowImagesOfMUImageAlbum plugin provides images of an album.
 *
 ...
 */
function smarty_function_munewsShowImagesOfMUImageAlbum($params, $view)
{
    $images = array();
    
    $albumid = $params['albumid'];
    $serviceManager = ServiceUtil::getManager();
    $modelhelper = new MUImage_Util_Model($serviceManager);
    ...
    if (array_key_exists('assign', $params)) {
        $view->assign($params['assign'], $images);
        return;
    }
    return $images;
}
