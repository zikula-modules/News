...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    <fieldset>
      ...
      <div class="z-formrow">
        ...
        {if $muimageAlbum eq 0 && $useMUImage eq false}
        <div class="z-formrow">
        ...
        {/if}
        {if $muimageAlbum eq 1 && $useMUImage eq true}
        <div class="z-formrow">
        ...
        <div class="z-formrow">
            ...
            {formintinput disabled=disabled group='message' id='weight' mandatory=false __title='Enter the weight of the message' maxLength=2 cssClass='required validate-digits' }
    ...
    {include file='user/include_categories_edit.tpl' obj=$message groupName='messageObj'}
    {if $mode ne 'create'}
        {include file='user/include_standardfields_edit.tpl' obj=$message}
    {/if}
