...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='mUNewsObjectType' __text='Object type'}
            {munewsObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='mUNewsObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {munewsItemSelector id='id' group='data' objectType=$objectType}
    </div>
