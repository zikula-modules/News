...
abstract class AbstractItemListType extends AbstractContentFormType
{
    ...
    public function addObjectTypeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('objectType', ChoiceType::class, [
            ...
            'empty_data' => 'message',
            'attr' => [
                'title' => $this->__('If you change this please save the element once to reload the parameters below.', 'munewsmodule')
            ],
            'help' => $this->__('If you change this please save the element once to reload the parameters below.', 'munewsmodule'),
            'choices' => [
