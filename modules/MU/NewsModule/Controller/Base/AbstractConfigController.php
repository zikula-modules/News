...
abstract class AbstractConfigController extends AbstractController
{
    ...
    {
        if (!$this->get('mu_news_module.permission_helper')->hasPermission(ACCESS_ADMIN)) {
            throw new AccessDeniedException();
        }
        
        $form = $this->createForm(ConfigType::class, $this->get('mu_news_module.app_settings'));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('save')->isClicked()) {
                ...
                $this->get('logger')->notice('{app}: User {user} updated the configuration.', ['app' => 'MUNewsModule', 'user' => $userName]);
