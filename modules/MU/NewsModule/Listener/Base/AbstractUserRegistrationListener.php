...
abstract class AbstractUserRegistrationListener implements EventSubscriberInterface
{
     ...
     * registration process is a full user record. Instead, an `user.account.create` event will fire.
     ...
     * an `user.account.create` event will fire. This is a storage-level event, not a UI event. It should not be
