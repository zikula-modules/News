 ...
 */
class MUNews_Block_Base_Moderation extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('MUNews:ModerationBlock:', 'Block title::');
    }
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('MUNews:ModerationBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $workflowHelper = new MUNews_Util_Workflow($this->serviceManager);
