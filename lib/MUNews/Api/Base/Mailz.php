 ...
 */
class MUNews_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins(array $args = array())
    {
        ...
        $plugins[] = array(
            'pluginid'      => 1,
            'module'        => 'MUNews',
            'title'         => $this->__('3 newest messages'),
            'description'   => $this->__('A list of the three newest messages.')
        );
        $plugins[] = array(
            'pluginid'      => 2,
            'module'        => 'MUNews',
            'title'         => $this->__('3 random messages'),
            'description'   => $this->__('A list of three random messages.')
        );
        return $plugins;
    }
    ...
    public function getContent(array $args = array())
    {
        ...
        list($entities, $objectCount) = ModUtil::apiFunc('MUNews', 'selection', 'getEntitiesPaginated', $selectionArgs);
    
        $view = Zikula_View::getInstance('MUNews', true);
        ...
        if ($args['contenttype'] == 't') { /* text */
            return $view->fetch('mailz/itemlist_message_text.tpl');
        } else {
            //return $view->fetch('contenttype/itemlist_display.html');
            return $view->fetch('mailz/itemlist_message_html.tpl');
        }
    }
}
