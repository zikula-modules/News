 ...
 */
class MUNews_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache(array $args = array())
    {
        ...
        $view = Zikula_View::getInstance('MUNews');
        ...
        $cacheIds[] = 'MUNews/user/main'; // main function
        $cacheIds[] = 'MUNews/user/view/' . $objectType; // view function (list views)
        $cacheIds[] = 'MUNews/user/display/' . $objectType . '|' . $instanceId; // display function (detail views)
