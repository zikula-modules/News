 ...
 */
class MUNews_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest messages');
    }
    ...
    {
        return $this->__('List of messages');
    }
    ...
    {
        return $this->__('This plugin shows a list of messages of the MUNews module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['message'] = array('name' => $this->__('Messages'));
        }
