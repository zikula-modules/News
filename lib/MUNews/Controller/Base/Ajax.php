 ...
 */
class MUNews_Controller_Base_Ajax extends Zikula_Controller_AbstractAjax
{
    ...
    public function getItemListFinder()
    {
        ...
        if ($this->request->isPost() && $this->request->request->has('ot')) {
            $objectType = $this->request->request->filter('ot', 'message', FILTER_SANITIZE_STRING);
        ...
        $entityClass = 'MUNews_Entity_' . ucfirst($objectType);
    ...
    public function checkForDuplicate()
    {
        ...
        $objectType = $postData->filter('ot', 'message', FILTER_SANITIZE_STRING);
        $controllerHelper = new MUNews_Util_Controller($this->serviceManager);
