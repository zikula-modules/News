 ...
 */
class MUNews_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('MUNews list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of MUNews objects.', $dom);
    }
    ...
    public function loadData(&$data)
    {
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            $idFields = ModUtil::apiFunc('MUNews', 'selection', 'getIdFields', array('ot' => $this->objectType));
            $this->catRegistries = ModUtil::apiFunc('MUNews', 'category', 'getAllPropertiesWithMainCat', array('ot' => $this->objectType, 'arraykey' => $idFields[0]));
            $this->catProperties = ModUtil::apiFunc('MUNews', 'category', 'getAllProperties', array('ot' => $this->objectType));
        }
    
        if (!isset($data['catIds'])) {
            $primaryRegistry = ModUtil::apiFunc('MUNews', 'category', 'getPrimaryProperty', array('ot' => $this->objectType));
    ...
    public function display()
    {
        ...
        $entityClass = 'MUNews_Entity_' . ucwords($this->objectType);
        $serviceManager = ServiceUtil::getManager();
        $entityManager = $serviceManager->getService('doctrine.entitymanager');
        $repository = $entityManager->getRepository($entityClass);
    
        // ensure that the view does not look for templates in the Content module (#218)
        $this->view->toplevelmodule = 'MUNews';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'MUNews:' . ucwords($this->objectType) . ':';
        $instance = '::';
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            if (is_array($this->catIds) && count($this->catIds) > 0) {
                $qb = ModUtil::apiFunc('MUNews', 'category', 'buildFilterClauses', array('qb' => $qb, 'ot' => $this->objectType, 'catids' => $this->catIds));
            }
        }
    ...
    {
        return array('objectType' => 'message',
                     'sorting' => 'default',
                     'amount' => 1,
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/MUNews/templates/plugins');
