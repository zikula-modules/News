 ...
 */
class MUNews_Form_Handler_Admin_Message_Base_Edit extends MUNews_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->uploadFields = array('imageUpload1' => false, 'imageUpload2' => false, 'imageUpload3' => false, 'imageUpload4' => false);
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            $modelHelper = new MUNews_Util_Model($this->view->getServiceManager());
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the message yet as other items are required which must be created before!'));
        ...
        if (count($this->listFields) > 0) {
            $helper = new MUNews_Util_ListEntries($this->view->getServiceManager());
    ...
    public function applyAction(array $args = array())
    {
        ...
        try {
            ...
            $workflowHelper = new MUNews_Util_Workflow($this->view->getServiceManager());
