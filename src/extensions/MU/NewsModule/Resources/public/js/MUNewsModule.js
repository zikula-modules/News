...
function mUNewsToggleFlag(objectType, fieldName, itemId) {
    jQuery.ajax({
        ...
        /*if (data.message) {
            mUNewsSimpleAlert(toggleLink, Translator.trans('Success'), data.message, 'toggle' + idSuffix + 'DoneAlert', 'success');
        }*/
    ...
    jQuery('#sortableTable > tbody').sortable({
        ...
        update: function (event, ui) {
            jQuery.ajax({
                ...
                /*if (data.message) {
                    mUNewsSimpleAlert(jQuery('#sortableTable'), Translator.trans('Success'), data.message, 'sortingDoneAlert', 'success');
                }*/
